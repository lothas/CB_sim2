function [  ] = GA_HipOnly( gen, pop, file_in, file_out )
...
if NAnkleT==0
    Keys = {'omega0','P_LegE',   'Pulses',...
        'kOmega_u','kTorques_u','kOmega_d','kTorques_d';...
                   1,       1,  [NHipT,2],...
                 1,         1,           1,           1};
    Range = {0.7, 0.50, [-MaxHipT, 0, 0.01],...
        -6, TorqueFBMin, -6, TorqueFBMin; % Min
             1.7, 0.85, [MaxHipT, 0.99, 0.99],...
        6, TorqueFBMax,  6, TorqueFBMax}; % Max
end
if NHipT==0
    Keys = {'omega0','P_LegE',    'Pulses',...
        'kOmega_u','kTorques_u','kOmega_d','kTorques_d';...
                   1,       1, [NAnkleT,1],...
                 1,         1,           1,           1};
    Range = {0.7, 0.50, [-MaxAnkleT, 0, 0.01],...
        -6, TorqueFBMin, -6, TorqueFBMin; % Min
             1.7, 0.85, [MaxAnkleT, 0.99, 0.99],...
        6, TorqueFBMax,  6, TorqueFBMax}; % Max
end
MutDelta0 = 0.04;
MutDelta1 = 0.02;
