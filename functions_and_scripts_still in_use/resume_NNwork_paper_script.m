...
parametersCells = {'period_desired','b',...
    'w_{12}','w_{13}','w_{14}',...
    'w_{21}','w_{23}','w_{24}',...
    'w_{31}','w_{32}','w_{34}',...
    'w_{41}','w_{42}','w_{43}'};
...
parametersCells = {'period_desired',...
    'w_{12}','w_{13}','w_{14}',...
    'w_{21}','w_{23}','w_{24}',...
    'w_{31}','w_{32}','w_{34}',...
    'w_{41}','w_{42}','w_{43}'};
...
%% NN input outputs: (option 7)
parametersCells = {'period_desired','tau'...
    'w_{12}','w_{13}','w_{14}',...
    'w_{21}','w_{23}','w_{24}',...
    'w_{31}','w_{32}','w_{34}',...
    'w_{41}','w_{42}','w_{43}'};
...
% note: not sure it would run with two outputs
...
HiddenN = [2,5,10,15,20,25,30,35,40,45,50];
% HiddenN = [3,5];
NumOfRepeats = 5;
