...
%                     'Color',Colors{2});
            ...
            case 'Energy'
                ...
                h = zeros(5,1);
                h(1) = plot(Data.Param,Data.dPotE,...
                    LineStyles{1},'LineWidth',LineWidth,...
                    'Color',Colors{1});
                h(2) = plot(Data.Param,Data.dKinEIm,...
                    LineStyles{2},'LineWidth',LineWidth,...
                    'Color',Colors{2});
                h(3) = plot(Data.Param,Data.dKinEFr,...
                    LineStyles{3},'LineWidth',LineWidth,...
                    'Color',Colors{3});
                h(4) = plot(Data.Param,Data.ContEff,...
                    LineStyles{4},'LineWidth',LineWidth,...
                    'Color',Colors{4});
                h(5) = plot(Data.Param,Data.AbsContEff,...
