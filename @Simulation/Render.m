...
% Renders the simulation graphics
            ...
            if sim.Once
                ...
                if ishandle(sim.Fig) && strcmp(get(sim.Fig,'type'),'figure')
                    ...
                    if isempty(findobj(gcf,'Type','uicontrol'))
                        % Make window larger
                        set(sim.Fig,'Position', [sim.FigWidth 150,...
                ...
                if isprop(sim.Con,'s_in')
                    ...
                    sim.hParam = ...
                        ...
                        'Position', [btn_x0+0.05 btn_y0-0.055 0.10 0.035], ...
                        'BackgroundColor', [1 1 1]);
                    uicontrol('Style', 'pushbutton', 'String', '+',...
                    'Units','normalized','FontSize',16,'FontWeight','bold',...
                        'Position', [btn_x0+0.165 btn_y0-0.05 0.035 0.035],...
                ...
                uicontrol('Style', 'pushbutton', 'String', 'Stop Simulation',...
                    'Units','normalized','FontSize',12,...
                    'Position', [btn_x0 btn_y0 0.2 0.05],...
                ...
                sim.hTime = uicontrol('Style', 'text',...
                    ...
                    'FontSize',12,...
                    'Units','normalized',...
                    'Position', [btn_x0+0.01 btn_y0-btn_delta-0.14 0.18 0.12],...
                ...
                sim.hConv = uicontrol('Style', 'text',...
                    ...
                    'FontSize',12,...
                    'Units','normalized',...
                    'Position', [btn_x0+0.01 btn_y0-btn_delta-0.2 0.18 0.06],...
                    'backgroundcolor',get(gca,'color')); 
    ...
    if ~isempty(X)
        ...
        set(sim.hTime,'string',...
            sprintf(sim.TimeStr,t(1),sim.Con.GetPhasePerc(X(sim.ConCo)),...
                sim.Env.SurfSlope(sim.Mod.xS)*180/pi,sim.Mod.curSpeed));
