...
for i=1:4
    switch whichParam
        case {'VelFit','NrgEffFit',...
             ...
             'VelRangeFit #4','VelRangeFit #5','VelRangeFit #6',...
             'VelRangeFit #7','VelRangeFit #8','EigenFit'}
            ID = strcmp(whichParam,obj.fitnessOrder);
             Y = squeeze(obj.data{1,i}.GA.Fit(:,ID,X_data));
        ...
        case {'tau','b','c_1','c_2','c_3','c_4',...
              ...
              'w_{31}','w_{32}','w_{34}','w_{41}','w_{42}','w_{43}',...
              'ks_\tau','ks_c1','ks_c2','ks_c3','ks_c4'}
             ID = strcmp(whichParam,obj.seqOrder_extend);
             Y = squeeze(obj.data{1,i}.GA.Seqs(:,ID,X_data));
        otherwise
            error('invalid Param...');
    end
